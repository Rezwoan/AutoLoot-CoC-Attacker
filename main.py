...
def deploy_heroes():
    ...
    Then:
        - Click HERO1_BUTTON and HERO2_BUTTON again to activate abilities.
    """
    ...
    # Small wait before triggering abilities
    print("[INFO] Waiting a bit before activating hero abilities...")
    time.sleep(5.0)

    # Activate abilities by clicking the hero buttons again
    print("[INFO] Activating hero abilities via bar buttons...")
    print("  [HERO1 ABILITY] Clicking HERO1_BUTTON")
    move_and_click(HERO1_BUTTON[0], HERO1_BUTTON[1],
                   move_duration=0.15, post_delay=0.2)

    print("  [HERO2 ABILITY] Clicking HERO2_BUTTON")
    move_and_click(HERO2_BUTTON[0], HERO2_BUTTON[1],
                   move_duration=0.15, post_delay=0.2)

    print("[INFO] Hero deployment and ability activation complete.")
...
def run_full_attack():
    ...
    Full sequence:
        ...
        8) Deploy heroes & abilities
        9) Wait for 50%
        10) Surrender and return home
    """
